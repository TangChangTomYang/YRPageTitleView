...
@interface YRScrollPageSubOneVC ()<UITableViewDataSource,UITableViewDelegate,YRScrollPageTableViewDelegate>

@property (nonatomic, strong) YRScrollPageTableView *tableView;
@end

@implementation YRScrollPageSubOneVC
