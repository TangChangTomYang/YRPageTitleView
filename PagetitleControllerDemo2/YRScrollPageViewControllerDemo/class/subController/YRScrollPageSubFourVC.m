...
@interface YRScrollPageSubFourVC ()<UITableViewDataSource,UITableViewDelegate,YRScrollPageTableViewDelegate>
@property (nonatomic, strong) YRScrollPageTableView *tableView;
@end

@implementation YRScrollPageSubFourVC
