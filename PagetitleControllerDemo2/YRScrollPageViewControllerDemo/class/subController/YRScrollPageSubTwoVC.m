...
@interface YRScrollPageSubTwoVC ()<UITableViewDataSource,UITableViewDelegate,YRScrollPageTableViewDelegate>
@property (nonatomic, strong) YRScrollPageTableView *tableView;
@end

@implementation YRScrollPageSubTwoVC
